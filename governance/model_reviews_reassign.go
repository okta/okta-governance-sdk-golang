...
func (o *ReviewsReassign) UnmarshalJSON(bytes []byte) (err error) {
	varReviewsReassign := _ReviewsReassign{}

	err = json.Unmarshal(bytes, &varReviewsReassign)
	if err == nil {
