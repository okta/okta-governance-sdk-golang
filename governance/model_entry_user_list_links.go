...
// checks if the EntryUserListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntryUserListLinks{}
...
func (o EntryUserListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *EntryUserListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEntryUserListLinks)
