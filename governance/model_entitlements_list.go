...
// checks if the EntitlementsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementsList{}
...
func (o EntitlementsList) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementsList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEntitlementsList)
