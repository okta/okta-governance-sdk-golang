...
// checks if the ReviewReassignListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewReassignListLinks{}
...
func (o ReviewReassignListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *ReviewReassignListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varReviewReassignListLinks)
