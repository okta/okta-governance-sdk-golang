...
// checks if the RcarEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RcarEntry{}
...
func (o RcarEntry) ToMap() (map[string]interface{}, error) {
...
func (o *RcarEntry) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRcarEntry)
