...
// checks if the CollectionInfoSparse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionInfoSparse{}
...
func (o CollectionInfoSparse) ToMap() (map[string]interface{}, error) {
...
func (o *CollectionInfoSparse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCollectionInfoSparse)
