...
// checks if the ValidRequesterSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidRequesterSetting{}
...
func (o ValidRequesterSetting) ToMap() (map[string]interface{}, error) {
...
func (o *ValidRequesterSetting) UnmarshalJSON(data []byte) (err error) {
	varValidRequesterSetting := _ValidRequesterSetting{}

	err = json.Unmarshal(data, &varValidRequesterSetting)
