...
// checks if the OktaGroupResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OktaGroupResource{}
...
func (o OktaGroupResource) ToMap() (map[string]interface{}, error) {
...
func (o *OktaGroupResource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOktaGroupResource)
