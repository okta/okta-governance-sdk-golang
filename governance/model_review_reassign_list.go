...
// checks if the ReviewReassignList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewReassignList{}
...
func (o ReviewReassignList) ToMap() (map[string]interface{}, error) {
...
func (o *ReviewReassignList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varReviewReassignList)
