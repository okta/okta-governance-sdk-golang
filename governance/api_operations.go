...
type OperationsAPI interface {
	...
	/*
		GetOperation Retrieve an operation
	...
	*/
	...
	//  @return Operation
	GetOperationExecute(r ApiGetOperationRequest) (*Operation, *APIResponse, error)
}
...
func (r ApiGetOperationRequest) Execute() (*Operation, *APIResponse, error) {
...
//
//	@return Operation
func (a *OperationsAPIService) GetOperationExecute(r ApiGetOperationRequest) (*Operation, *APIResponse, error) {
	var (
	...
	localVarPath := localBasePath + "/governance/api/v1/operations/{operationId}"
