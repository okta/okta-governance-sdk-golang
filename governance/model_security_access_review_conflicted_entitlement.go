...
func (o *SecurityAccessReviewConflictedEntitlement) UnmarshalJSON(bytes []byte) (err error) {
	varSecurityAccessReviewConflictedEntitlement := _SecurityAccessReviewConflictedEntitlement{}

	err = json.Unmarshal(bytes, &varSecurityAccessReviewConflictedEntitlement)
	if err == nil {
