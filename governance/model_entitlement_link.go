...
// checks if the EntitlementLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementLink{}
...
func (o EntitlementLink) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementLink) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEntitlementLink)
