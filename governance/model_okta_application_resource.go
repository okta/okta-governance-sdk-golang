...
// checks if the OktaApplicationResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OktaApplicationResource{}
...
func (o OktaApplicationResource) ToMap() (map[string]interface{}, error) {
...
func (o *OktaApplicationResource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOktaApplicationResource)
