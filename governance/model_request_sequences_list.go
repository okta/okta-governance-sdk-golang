...
// checks if the RequestSequencesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestSequencesList{}
...
func (o RequestSequencesList) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSequencesList) UnmarshalJSON(data []byte) (err error) {
	varRequestSequencesList := _RequestSequencesList{}

	err = json.Unmarshal(data, &varRequestSequencesList)
