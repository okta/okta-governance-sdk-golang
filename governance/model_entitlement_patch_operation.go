...
// checks if the EntitlementPatchOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementPatchOperation{}
...
func (o EntitlementPatchOperation) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementPatchOperation) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEntitlementPatchOperation)
