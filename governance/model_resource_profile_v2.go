...
// checks if the ResourceProfileV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceProfileV2{}

// ResourceProfileV2 A limited set of properties from the resource's profile
type ResourceProfileV2 struct {
...
type _ResourceProfileV2 ResourceProfileV2
...
func (o ResourceProfileV2) MarshalJSON() ([]byte, error) {
...
func (o ResourceProfileV2) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceProfileV2) UnmarshalJSON(data []byte) (err error) {
	varResourceProfileV2 := _ResourceProfileV2{}

	err = json.Unmarshal(data, &varResourceProfileV2)

	if err != nil {
		return err
	}

	*o = ResourceProfileV2(varResourceProfileV2)
...
type NullableResourceProfileV2 struct {
	value *ResourceProfileV2
	isSet bool
}

func (v NullableResourceProfileV2) Get() *ResourceProfileV2 {
	return v.value
}

func (v *NullableResourceProfileV2) Set(val *ResourceProfileV2) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceProfileV2) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceProfileV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceProfileV2(val *ResourceProfileV2) *NullableResourceProfileV2 {
	return &NullableResourceProfileV2{value: val, isSet: true}
}

func (v NullableResourceProfileV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceProfileV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
