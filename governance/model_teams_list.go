...
// checks if the TeamsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamsList{}
...
func (o TeamsList) ToMap() (map[string]interface{}, error) {
...
func (o *TeamsList) UnmarshalJSON(data []byte) (err error) {
	varTeamsList := _TeamsList{}

	err = json.Unmarshal(data, &varTeamsList)
