...
// checks if the SecurityAccessReviewAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityAccessReviewAction{}
...
func (o SecurityAccessReviewAction) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityAccessReviewAction) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSecurityAccessReviewAction)
