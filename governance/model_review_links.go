...
// checks if the ReviewLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewLinks{}
...
func (o *ReviewLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varReviewLinks)
