...
// checks if the RequestResourceCatalogEntryCreatable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestResourceCatalogEntryCreatable{}
...
func (o RequestResourceCatalogEntryCreatable) ToMap() (map[string]interface{}, error) {
...
func (o *RequestResourceCatalogEntryCreatable) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRequestResourceCatalogEntryCreatable)
