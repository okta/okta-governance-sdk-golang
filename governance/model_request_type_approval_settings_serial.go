...
// checks if the RequestTypeApprovalSettingsSerial type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestTypeApprovalSettingsSerial{}
...
func (o RequestTypeApprovalSettingsSerial) ToMap() (map[string]interface{}, error) {
...
func (o *RequestTypeApprovalSettingsSerial) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRequestTypeApprovalSettingsSerial)
