...
// checks if the SecurityAccessReviewAccessItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityAccessReviewAccessItems{}
...
func (o SecurityAccessReviewAccessItems) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityAccessReviewAccessItems) UnmarshalJSON(data []byte) (err error) {
	varSecurityAccessReviewAccessItems := _SecurityAccessReviewAccessItems{}

	err = json.Unmarshal(data, &varSecurityAccessReviewAccessItems)
