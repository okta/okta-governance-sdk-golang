...
// checks if the EntitlementBundlesArrayFullInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementBundlesArrayFullInner{}
...
func (o EntitlementBundlesArrayFullInner) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementBundlesArrayFullInner) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEntitlementBundlesArrayFullInner)
