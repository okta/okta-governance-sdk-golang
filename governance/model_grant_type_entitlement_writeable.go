...
// checks if the GrantTypeEntitlementWriteable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GrantTypeEntitlementWriteable{}

// GrantTypeEntitlementWriteable entitlements as the grant source
type GrantTypeEntitlementWriteable struct {
	// Additive grant type for assigning specific entitlement and respective value(s).
...
type _GrantTypeEntitlementWriteable GrantTypeEntitlementWriteable
...
func NewGrantTypeEntitlementWriteable(grantType string, target TargetResource, entitlements []EntitlementCreatable, targetPrincipal TargetPrincipal) *GrantTypeEntitlementWriteable {
	this := GrantTypeEntitlementWriteable{}
...
func (o GrantTypeEntitlementWriteable) MarshalJSON() ([]byte, error) {
...
func (o GrantTypeEntitlementWriteable) ToMap() (map[string]interface{}, error) {
...
func (o *GrantTypeEntitlementWriteable) UnmarshalJSON(data []byte) (err error) {
	...
	varGrantTypeEntitlementWriteable := _GrantTypeEntitlementWriteable{}

	err = json.Unmarshal(data, &varGrantTypeEntitlementWriteable)

	if err != nil {
		return err
	}

	*o = GrantTypeEntitlementWriteable(varGrantTypeEntitlementWriteable)
...
type NullableGrantTypeEntitlementWriteable struct {
	value *GrantTypeEntitlementWriteable
	isSet bool
}

func (v NullableGrantTypeEntitlementWriteable) Get() *GrantTypeEntitlementWriteable {
	return v.value
}

func (v *NullableGrantTypeEntitlementWriteable) Set(val *GrantTypeEntitlementWriteable) {
	v.value = val
	v.isSet = true
}

func (v NullableGrantTypeEntitlementWriteable) IsSet() bool {
	return v.isSet
}

func (v *NullableGrantTypeEntitlementWriteable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGrantTypeEntitlementWriteable(val *GrantTypeEntitlementWriteable) *NullableGrantTypeEntitlementWriteable {
	return &NullableGrantTypeEntitlementWriteable{value: val, isSet: true}
}

func (v NullableGrantTypeEntitlementWriteable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGrantTypeEntitlementWriteable) UnmarshalJSON(src []byte) error {
	v.isSet = true
