...
// checks if the RequestersReplacePatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestersReplacePatch{}
...
func (o RequestersReplacePatch) ToMap() (map[string]interface{}, error) {
...
func (o *RequestersReplacePatch) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRequestersReplacePatch)
