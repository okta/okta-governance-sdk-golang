...
// OperationLinks Link relations available for the operation
...
func NewOperationLinks(self Link) *OperationLinks {
	this := OperationLinks{}
	this.Self = self
	return &this
}
...
func (o *OperationLinks) GetSelf() Link {
	if o == nil {
		var ret Link
		return ret
	}
...
func (o *OperationLinks) GetSelfOk() (*Link, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Self, true
...
func (o *OperationLinks) SetSelf(v Link) {
	o.Self = v
}
