...
// checks if the GrantListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GrantListLinks{}
...
func (o GrantListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GrantListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varGrantListLinks)
