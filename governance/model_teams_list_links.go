...
// checks if the TeamsListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamsListLinks{}
...
func (o TeamsListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *TeamsListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTeamsListLinks)
