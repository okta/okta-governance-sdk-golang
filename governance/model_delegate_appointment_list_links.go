...
// checks if the DelegateAppointmentListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DelegateAppointmentListLinks{}
...
func (o DelegateAppointmentListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *DelegateAppointmentListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDelegateAppointmentListLinks)
