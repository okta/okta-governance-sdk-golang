...
// checks if the AssignmentPatchOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignmentPatchOperation{}
...
func (o AssignmentPatchOperation) ToMap() (map[string]interface{}, error) {
...
func (o *AssignmentPatchOperation) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssignmentPatchOperation)
