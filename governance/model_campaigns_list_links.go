...
// checks if the CampaignsListLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignsListLinks{}
...
func (o CampaignsListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignsListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCampaignsListLinks)
