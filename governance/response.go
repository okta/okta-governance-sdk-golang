...
type APIResponse struct {
	*http.Response
	cli *OktaGovernanceAPIClient
	pg  Pagination
}

func newAPIResponse(r *http.Response, cli *OktaGovernanceAPIClient, v interface{}) *APIResponse {
	var pg Pagination
	// switch v
...
func buildResponse(resp *http.Response, cli *OktaGovernanceAPIClient, v interface{}) (*APIResponse, error) {
