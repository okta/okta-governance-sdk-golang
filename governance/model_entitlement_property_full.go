...
func (o EntitlementPropertyFull) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementPropertyFull) UnmarshalJSON(data []byte) (err error) {
	varEntitlementPropertyFull := _EntitlementPropertyFull{}

	err = json.Unmarshal(data, &varEntitlementPropertyFull)
