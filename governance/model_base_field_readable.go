...
// checks if the BaseFieldReadable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseFieldReadable{}
...
func (o BaseFieldReadable) ToMap() (map[string]interface{}, error) {
...
func (o *BaseFieldReadable) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBaseFieldReadable)
