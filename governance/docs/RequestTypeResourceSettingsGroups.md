# RequestTypeResourceSettingsGroups
...
------------ | ------------- | ------------- | -------------
**Type** | **string** |  | 
**TargetResources** | [**[]OktaGroupResource**](OktaGroupResource.md) | List of Okta groups | 

## Methods

### NewRequestTypeResourceSettingsGroups
...
### NewRequestTypeResourceSettingsGroupsWithDefaults
