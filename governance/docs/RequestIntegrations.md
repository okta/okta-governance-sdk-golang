...
------------ | ------------- | ------------- | -------------
**Settings** | Pointer to [**[]SlackIntegrationSettings**](SlackIntegrationSettings.md) | Integration settings | [optional] 

## Methods

### NewRequestIntegrations
...
### NewRequestIntegrationsWithDefaults
