...
------------- | ------------- | -------------
[**GetCatalogEntryRequestFieldsV2**](CatalogsAPI.md#GetCatalogEntryRequestFieldsV2) | **Get** /governance/api/v2/catalogs/default/entries/{entryId}/users/{userId}/request-fields | Retrieve the request fields
