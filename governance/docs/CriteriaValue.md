...
------------ | ------------- | ------------- | -------------
**Type** | Pointer to **string** | Criteria value type | [optional] 
**Value** | Pointer to [**[]EntitlementFull**](EntitlementFull.md) | Collection of entitlements with associated values | [optional] 
