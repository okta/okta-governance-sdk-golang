# RiskRuleCriteriaValue

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Type** | Pointer to **string** | The type of the criteria value | [optional] 
**Value** | Pointer to [**[]ReviewEntitlement**](ReviewEntitlement.md) | Collection of entitlements with associated values | [optional] 

## Methods

### NewRiskRuleCriteriaValue
...
### NewRiskRuleCriteriaValueWithDefaults
