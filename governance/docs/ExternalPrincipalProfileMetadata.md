# ExternalPrincipalProfileMetadata
...
### NewExternalPrincipalProfileMetadata
...
### NewExternalPrincipalProfileMetadataWithDefaults
...
GetUserAssignmentCount returns the UserAssignmentCount field if non-nil, zero value otherwise.

### GetUserAssignmentCountOk

`func (o *ExternalPrincipalProfileMetadata) GetUserAssignmentCountOk() (*int32, bool)`

GetUserAssignmentCountOk returns a tuple with the UserAssignmentCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetUserAssignmentCount

`func (o *ExternalPrincipalProfileMetadata) SetUserAssignmentCount(v int32)`

SetUserAssignmentCount sets UserAssignmentCount field to given value.

### HasUserAssignmentCount
