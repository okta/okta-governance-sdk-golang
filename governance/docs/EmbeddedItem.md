...
------------ | ------------- | ------------- | -------------
**Id** | **string** | Unique identifier for the embedded resource | 
**Name** | **string** | Display name of the embedded resource | 
**Metadata** | Pointer to **map[string]interface{}** | Additional metadata specific to this embedded resource type | [optional] 
