...
func main() {
	principalEntitlementsChangeId := "governance/api/v1/principal-entitlements-changes/cmVwMWtOQ2NmQnhhRWVEbXcwZzI6cmVwOHBCVVRWVG9na2lYNWUwZzI" // string | Unique identifier for the principal entitlements change. The entitlement change is Base64-encoded.
...
**principalEntitlementsChangeId** | **string** | Unique identifier for the principal entitlements change. The entitlement change is Base64-encoded. | 
