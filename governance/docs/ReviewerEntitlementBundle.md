# ReviewerEntitlementBundle

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Id** | **string** | The entitlement bundle id | 
**Name** | **string** | The entitlement bundle name | 

## Methods

### NewReviewerEntitlementBundle
...
### NewReviewerEntitlementBundleWithDefaults
