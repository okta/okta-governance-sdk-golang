# RevokePrincipalAccessResourceLinksLinksPrincipalEntitlements

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Href** | Pointer to **string** | Link to principal entitlements | [optional] 

## Methods

### NewRevokePrincipalAccessResourceLinksLinksPrincipalEntitlements
...
### NewRevokePrincipalAccessResourceLinksLinksPrincipalEntitlementsWithDefaults
