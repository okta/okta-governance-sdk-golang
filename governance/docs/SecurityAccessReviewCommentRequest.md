# SecurityAccessReviewCommentRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Comment** | **string** | A comment for the security access review | 

## Methods

### NewSecurityAccessReviewCommentRequest
...
### NewSecurityAccessReviewCommentRequestWithDefaults
