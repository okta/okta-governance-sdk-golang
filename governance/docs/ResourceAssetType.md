...
**Links** | Pointer to [**ResourceAssetTypeLinks**](ResourceAssetTypeLinks.md) |  | [optional] 
**DisplayName** | **string** | The display name for the resource asset type | 

## Methods

### NewResourceAssetType
...
### NewResourceAssetTypeWithDefaults
