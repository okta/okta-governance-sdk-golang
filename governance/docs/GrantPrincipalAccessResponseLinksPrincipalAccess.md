# GrantPrincipalAccessResponseLinksPrincipalAccess

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Href** | **string** | The URL to the principal access GET endpoint | 

## Methods

### NewGrantPrincipalAccessResponseLinksPrincipalAccess
...
### NewGrantPrincipalAccessResponseLinksPrincipalAccessWithDefaults
