...
func (o *SecurityAccessReviewAccessesActionRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSecurityAccessReviewAccessesActionRequest := _SecurityAccessReviewAccessesActionRequest{}

	err = json.Unmarshal(bytes, &varSecurityAccessReviewAccessesActionRequest)
	if err == nil {
