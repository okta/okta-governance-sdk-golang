...
func (o RequestSequencesListLinks) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSequencesListLinks) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRequestSequencesListLinks)
