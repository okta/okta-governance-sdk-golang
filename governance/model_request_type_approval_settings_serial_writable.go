...
type RequestTypeApprovalSettingsSerialWritable struct {
	// Multiple approvals defined in a serial sequence:   * An approval isn't actionable until the previous approval is approved.   * An approval denial terminates the request and no subsequent approvals are actionable.
