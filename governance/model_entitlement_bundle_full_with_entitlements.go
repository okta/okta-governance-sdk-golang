...
type _EntitlementBundleFullWithEntitlements EntitlementBundleFullWithEntitlements
...
type NullableEntitlementBundleFullWithEntitlements struct {
	value *EntitlementBundleFullWithEntitlements
	isSet bool
}

func (v NullableEntitlementBundleFullWithEntitlements) Get() *EntitlementBundleFullWithEntitlements {
	return v.value
}

func (v *NullableEntitlementBundleFullWithEntitlements) Set(val *EntitlementBundleFullWithEntitlements) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitlementBundleFullWithEntitlements) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitlementBundleFullWithEntitlements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitlementBundleFullWithEntitlements(val *EntitlementBundleFullWithEntitlements) *NullableEntitlementBundleFullWithEntitlements {
	return &NullableEntitlementBundleFullWithEntitlements{value: val, isSet: true}
}

func (v NullableEntitlementBundleFullWithEntitlements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitlementBundleFullWithEntitlements) UnmarshalJSON(src []byte) error {
	v.isSet = true
