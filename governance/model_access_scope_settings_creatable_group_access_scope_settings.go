...
func (o AccessScopeSettingsCreatableGroupAccessScopeSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AccessScopeSettingsCreatableGroupAccessScopeSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessScopeSettingsCreatableGroupAccessScopeSettings := _AccessScopeSettingsCreatableGroupAccessScopeSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccessScopeSettingsCreatableGroupAccessScopeSettings)

	if err != nil {
		return err
	}

	*o = AccessScopeSettingsCreatableGroupAccessScopeSettings(varAccessScopeSettingsCreatableGroupAccessScopeSettings)
